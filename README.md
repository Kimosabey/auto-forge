# AutoForge
### Agentic CI/CD that plans, writes, and ships code through the software lifecycle.
...
```bash
# 1. Clone
git clone https://github.com/Kimosabey/auto-forge.git
cd auto-forge
...
## ✨ Key Features
- Issue → plan → code → PR pipeline
- AST-aware code generation
- CI-gated automated changes
...
| Docker | `Docker` | Containerized local deployment |
